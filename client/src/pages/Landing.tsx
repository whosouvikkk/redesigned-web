...
export default function Landing() {
  return (
    <div className="min-h-screen bg-black text-gray-200 selection:bg-pink-500/30 selection:text-white relative overflow-hidden font-sans">
      ...
      {/* 2. REAL LOOKUP EXAMPLES (JSON CARD FORMAT) */}
      <section className="py-24 px-6 max-w-7xl mx-auto z-10 relative">
        ...
        >
          <div className="max-w-2xl">
            ...
            <p className="text-gray-400 font-light text-lg">Raw JSON payloads generated by our backend. 5 key modules optimized for instant resolution.</p>
          </div>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-7xl mx-auto">
          <SampleCard 
            ...
            jsonString={`{\n  "mobile": "79803461xx",\n  "name": "Nikhil Naxxx",\n  "address": "S/O: Abani Nayek... West Bengal, 7211xx",\n  "circle": "JIO KOL",\n  "alt": "90077460xx",\n  "id": "[Redacted]",\n  "email": "N/A"\n}`}
          />
          <SampleCard 
            index={1} 
            icon={<ShieldCheck />} 
            ...
            jsonString={`{\n  "mobile": "97755547xx",\n  "name": "NIKHIL NAxxx",\n  "father_name": "ABAANI NAxxx",\n  "address": "vill Chilgora... 7211xx",\n  "aadhar": "[Aadhaar Redacted]",\n  "email": "Sangita.sur754@gmaxxx"\n}`}
          />
          <SampleCard 
            index={2} 
            icon={<Car />} 
            ...
            jsonString={`{\n  "reg_number": "KL41V35xx",\n  "owner": {\n    "name": "MUHAMMED IQBAL xxx",\n    "father": "ANSAR xxx"\n  },\n  "vehicle": {\n    "model": "SPLENDOR PLUS",\n    "fuel": "PETROL"\n  },\n  "financier": "TATA CAPITAL xxx"\n}`}
          />
          <SampleCard 
            index={3} 
            icon={<Key />} 
            ...
            jsonString={`{\n  "vehicle": "KL41V35xx",\n  "chassis_number": "MBLHAW222R5H00xxx",\n  "engine_number": "HA11E7R5G60xxx",\n  "mobile_number": "81291994xx"\n}`}
          />
          <SampleCard 
            index={4} 
            icon={<Crosshair />} 
...
// Updated SampleCard: Now renders a glowing JSON code block
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end">
        <div className="bg-black/60 border border-white/5 rounded-xl p-4 overflow-x-auto shadow-inner group-hover:border-pink-500/20 transition-colors">
