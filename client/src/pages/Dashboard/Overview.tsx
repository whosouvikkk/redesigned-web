  ...
  return (
    <div className="max-w-4xl font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-[#0d070a] border border-white/5 p-6 rounded-2xl shadow-3d shadow-glass-edge">
      ...
      <div className="bg-[#0d070a] border border-white/5 p-8 rounded-2xl shadow-3d shadow-glass-edge">
        ...
        <Link to="/dashboard/lookup" className="px-6 py-3 bg-gradient-to-b from-pink-500 to-pink-700 hover:from-pink-400 hover:to-pink-600 rounded-xl font-medium text-sm inline-flex items-center gap-2 transition-all shadow-[0_10px_20px_rgba(236,72,153,0.3)]">
