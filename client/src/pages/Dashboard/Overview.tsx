...
export default function Overview() {
  ...
  // FAILSAFE LOGIC: Trust the subscription string first. 
  // Only mark as inactive if an expiry date exists AND has passed.
    ...
    <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="bg-rose-500/10 border border-rose-500/20 p-6 md:p-8 rounded-[2rem] shadow-inner mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-xl md:text-2xl font-bold text-rose-400 mb-3 flex items-center gap-3">
              <ShieldAlert className="w-6 h-6 md:w-7 md:h-7" /> Access Paywall Active
            </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
        ...
        <StatCard 
          ...
          value={user?.subscription && user.subscription !== 'none' ? user.subscription.charAt(0).toUpperCase() + user.subscription.slice(1) : 'None'} 
      ...
      <div className="bg-black/40 backdrop-blur-2xl border border-white/10 p-6 md:p-8 rounded-[2rem] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.5)] relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h3 className="text-lg md:text-xl font-bold text-white mb-3 tracking-wide">Intelligence Directives</h3>
          <p className="text-gray-400 font-light text-sm md:text-base leading-relaxed mb-8 max-w-4xl">
            ...
            All searches are logged securely in your ledger. Ensure your actions comply with the MoonWitch Terms of Service.
          </p>
